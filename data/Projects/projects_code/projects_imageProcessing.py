...
# adding indices
for i,proj in enumerate(imageProcessingProjects):
    proj['ID'] = i+1
...
"https://projectideas.co.in/application-of-neural-network-in-handwriting-recognition/",
"https://projectideas.co.in/facial-keypoints-detection/",
"https://projectideas.co.in/image-mining-project-dotnet/",
...
"https://projectideas.co.in/expression-identification-using-image-processing-project-ideas/",
"https://projectideas.co.in/semisupervised-biased-maximum-margin-analysis-interactive-image-retrieval/",
"https://projectideas.co.in/automatic-image-equalization-contrast-enhancement-using-gaussian-mixture/",
"https://projectideas.co.in/scalable-face-image-retrieval-using-attribute-enhanced-sparse-codewords/",
"https://projectideas.co.in/effective-image-steganalysis-method-based-neighborhood-information-pixels/",
"https://projectideas.co.in/automatic-plant-leaf-classification-mobile-field-guide/",
"https://projectideas.co.in/secure-authenticated-reversible-data-hiding-encrypted-images/",
"https://projectideas.co.in/extended-visual-cryptography-scheme-without-pixel-expansion-halftone-images/",
"https://projectideas.co.in/secret-sharing-based-method-authentication-grayscale-document-images-via-use-png/",
"https://projectideas.co.in/robust-face-name-graph-matching-movie-character-identification/",
"https://projectideas.co.in/dymanic-method-secure-confidential-data-using-signcryption-steganography/",
"https://projectideas.co.in/mitigating-fire-based-disaster-using-ip/",
"https://projectideas.co.in/novel-data-embedding-method-using-adaptive-pixel-pair-matching/",
"https://projectideas.co.in/keyless-approach-image-encryption/",
"https://projectideas.co.in/n-square-approach-lossless-image-compression-decompression/",
"https://projectideas.co.in/efficient-real-time-moving-object-detection-method-video-surveillance-system/",
"https://projectideas.co.in/image-authentication-restoration-using-blockwise-fragile-watermarking-based-k-medoids-clustering-approach/",
"https://projectideas.co.in/robust-skew-detection-method-based-maximum-gradient-difference-r-signature/",
"https://projectideas.co.in/image-based-object-detection-varying-illumination-environments-specular-surfaces/",
"https://projectideas.co.in/new-block-compressive-sensing-control-number-measurements/",
"https://projectideas.co.in/secure-authentication-using-image-processing-visual-cryptography-banking-applications/",
"https://projectideas.co.in/lossless-image-compression-based-data-folding/",
"https://projectideas.co.in/chaotic-system-based-fragile-watermarking-scheme-image-tamper-detection/",
"https://projectideas.co.in/linear-distance-coding-image-classification/",
"https://projectideas.co.in/security-enhancement-scheme-image-steganography-using-s-des-technique/",
"https://projectideas.co.in/robust-watermarking-compressed-encrypted-jpeg2000-images/",
"https://projectideas.co.in/image-compression-decompression-using-adaptive-interpolation/"

]

for url, proj in zip(links, imageProcessingProjects):
    proj['URL']= url

print(len(links)) #40
print(len(imageProcessingProjects)) #40
print(imageProcessingProjects[-1])


from utils import write_selected_dict_values_to_file

write_selected_dict_values_to_file(imageProcessingProjects, 'imageProcessingProjects.txt')