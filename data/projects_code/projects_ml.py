...
links = [
"https://projectideas.co.in/heart-and-diabetes-disease-prediction-using-machine-learning/",
"https://projectideas.co.in/movie-success-prediction-using-machine-learning/",
"https://projectideas.co.in/airline-crash-prediction-using-machine-learning/",
"https://projectideas.co.in/rainfall-prediction-using-machine-learning/",
...
"https://projectideas.co.in/predicting-hospital-readmission-sin-the-medicare-population/",
"https://projectideas.co.in/4153-2/",
"https://projectideas.co.in/sentiment-as-a-predictor-of-wikipedia-editor-activity/",
...
"https://projectideas.co.in/parking-occupancy-prediction-and-pattern-analysis/",
"https://projectideas.co.in/stock-trend-prediction-with-technical-indicators-using-svm/",
"https://projectideas.co.in/predicting-usefulness-of-yelp-reviews/",
...
"https://projectideas.co.in/socialqa-an-online-social-network-based-question-and-answer-system/"
]

print(len(links)) #48 == projects 48
print(len(MachineLearningProjects))

for url, proj in zip(links, MachineLearningProjects):
    proj['URL']= url

print(len(links))
print(len(MachineLearningProjects))

print(MachineLearningProjects[40])


from utils import write_selected_dict_values_to_file

write_selected_dict_values_to_file(MachineLearningProjects, 'MachineLearningProjects.txt')